...
Provide an automated Jest test suite with an enforced coverage gate so application behavior is verified through public surfaces and regressions are caught before changes are considered complete.
