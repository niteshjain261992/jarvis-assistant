# websocket-message-controllers Specification

## Purpose

Define type-based dispatch from the WebSocket gateway to dedicated controller modules, keeping transport parsing thin and business logic isolated per inbound message type.
