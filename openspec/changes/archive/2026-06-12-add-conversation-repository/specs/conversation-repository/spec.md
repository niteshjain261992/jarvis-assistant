...
Define MongoDB persistence for conversation documents: typed enums, required fields with defaults, and repository CRUD operations. This capability is repository-only — no HTTP or service integration in this change.
...
The conversation repository module SHALL NOT be imported by any service, controller, route, or application bootstrap file in this change. Only the repository module itself and its dedicated tests MAY reference it.
